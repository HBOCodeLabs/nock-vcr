...
(function() {
  ...
  Cassette = (function() {
    ...
    function Cassette(name, options) {
      ...
      Object.defineProperty(this, 'recordBodiesToFiles', {
        get: function() {
          switch (options.recordBodiesToFiles) {
          case true:
            return true;
          case false:
            return false;
          default:
            return config.recordBodiesToFiles;
          }
        }
      });
      Object.defineProperty(this, 'cassetteDir', {
        get: function() {
          var baseDir;	   
          if (options.cassetteLibraryDir) {
            baseDir = options.cassetteLibraryDir;
          } else {
            baseDir = config.cassetteLibraryDir;
          }
      ...
      Object.defineProperty(this, 'file', {
        get: function() {
          ...
          return path.resolve(this.cassetteDir, fileName);
        }
      });
      ...
      Object.defineProperty(this, 'nockOptions', {
        get: function() {
          ...
          if (this.recordBodiesToFiles) {
            newOptions.recordBodiesToFiles = true;
            newOptions.bodyPath = this.cassetteDir;
          }
          return newOptions;
        }
      });
    ...
    Cassette.prototype.rec = function() {
      return nock.recorder.rec(true, this.nockOptions);
    };

    Cassette.prototype.play = function() {
      var name;
      nock.activate(this.nockOptions);
      if (this.exists) {
  ...
  module.exports = exports = {
    ...
    nockInstance: nock // expose the nock instance that nock-vcr uses since it's this instance (this module's module) that will be emitting events we're intersted in.
  };
